    ...
    <main>
      ...
      <section class="synopsis" id = synopsis>
        ...
        <div class="synopsis-display">
          ...
          <iframe width="30%" height="30%" src="https://www.youtube.com/embed/TcMBFSGVi1c"
          frameborder="0" allowfullscreen></iframe>
          <h3 class="movie-information">Plot Description</h3>
          <p>
          ...
          <h3 class="movie-information">Make a booking:</h3>
          <div class="booking">
